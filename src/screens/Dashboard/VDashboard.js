...
class VDashboard extends Component {
  componentDidMount(){
    ...
    render(){
        ...
        <h2 className="page-header-title">Welcome to your Store's Dashboard, {this.props.user.vendor?.name}</h2>
                  <div>
                    <RefreshData />
                  </div>
                </div>
            ...
            <CardAggregate borderLeft={'solid red 3px'} textColor={'text-linkedin'} aggregate={"Ghc"} numbers={this.props.dashboard.earningsToday} title={'Sales Today'} buttonStyle={'warning'} to={"/orders"}/>
            ...
            <CardAggregate borderLeft={'solid red 3px'} textColor={'text-instagram'} aggregate={"Ghc"} numbers={this.props.dashboard.earningsAllTime} title={'LifeTime Sales'} buttonStyle={'btn btn-gradient-02'} to={"/orders"}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(VDashboard);